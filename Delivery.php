...
<body>
	...
	<div id="wcu"><h2>Why choose us?</h2></div>		
			
			<table id="delivery" align="center" cellpadding="15px" cellspacing="20px">
				<tr>
					<td>
						<div id="delivery-name"><h1>Fast Delivery</h1></div>
					...
					<td>
						<div id="delivery-name"><h1>Delivery in Time</h1></div>
					...
					<td>
						<div id="delivery-name"><h1>Responsibility Rider</h1></div>
