            ...
            ?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php if ($rows['block'] == 1) { ?>
                                <a href="<?php echo SITEURL; ?>admin/unblock-category.php?ID=<?php echo $ID; ?>" class="btn-delete">Unhide</a>
                            <?php } else { ?>
                                <a href="<?php echo SITEURL; ?>admin/block-category.php?ID=<?php echo $ID; ?>" class="btn-delete">Hide</a>
                            <?php } ?>
                        </td>
                    </tr>
