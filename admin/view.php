                    ...
                    <div class="p-3 py-5">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12"><label class="labels">Status:</label>
                                <input <?php if ($status == "available") {
                                            echo "checked";
                                        } ?> type="radio" name="status" value="available"> Available
                                <input <?php if ($status == "unavailable") {
                                            echo "checked";
                                        } ?> type="radio" name="status" value="unavailable"> Unavailable
                            </div>
                        </div>
                        ...
                        <div class="mt-5 text-right">
                            ...
                            <button class="btn btn-primary profile-button" type="submit" name="submit" value="Update Food">Save Food</button>
                        </div>
                    </div>
                </div>
            </div>
