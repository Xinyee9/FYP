...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 16, 2022 at 10:12 AM
...
(14, 'food14', 'Creammy Corn Gemelli', 12.2, 'A delectable sauce consisting of puréed fresh corn and fragrant sautéed onions.', 's5.jpg', 500, 'available', 5, 2, 'Yes'),
...
(1, '2022-04-16', '04:01:26', '04:31:26', 'CHONG', '12, Jln porah', 'Skudai', 'Johor', 84600, 'Yet to be delivered', 1),
(2, '2022-04-16', '04:02:21', '04:32:21', 'CHONG', '12, Jln porah', 'Skudai', 'Johor', 84600, 'Order Confirm', 1),
(3, '2022-04-16', '04:03:58', '04:33:58', 'Jessie', '14,Jln Bukit Mewah', 'Seremban', 'Negeri Sembilan', 70450, 'Delivered', 3),
(4, '2022-04-16', '04:04:47', '04:34:47', 'Jessie', '14,Jln Bukit Mewah', 'Seremban', 'Negeri Sembilan', 70450, 'Delivered', 3);
...
(00002, 'admin', 'admin', 'auroraadmin@gmail.com', 'superadmin', 'Aurora', 'Admin', 0, ''),
...
--
ALTER TABLE `cart`
  MODIFY `cart_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
...
--
ALTER TABLE `real_cart`
  MODIFY `real_cart_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `trans`
--
ALTER TABLE `trans`
  MODIFY `transaction_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
