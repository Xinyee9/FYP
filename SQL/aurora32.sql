...
(1, 'food01', 'Blackpepper Chickenchop', 11, 'Marinated chicken grilled or pan-fried in a thick, strong black pepper sauce.', 'c1.jpeg', 500, 'available', 2, 3, 'No'),
...
(64, '2022-04-06', '02:37:49', '03:07:49', 'Robert Lim Jia Le ', '65, Jalan Pelangi 3', 'Skudai', 'Johor', 84600, 'Order Confirm', 1),
(65, '2022-04-06', '02:41:20', '03:11:20', 'Robert Lim Jia Le ', '65, Jalan Pelangi 3', 'Skudai', 'Johor', 84600, 'Order Confirm', 1),
(66, '2022-04-06', '03:23:49', '03:53:49', 'Jayson Lim Chun Keat', '65, Jalan Pelangi 3', 'Bukit Beruang', 'Melaka', 75450, 'Delivered', 10),
(67, '2022-04-07', '04:32:23', '05:02:23', 'Chong', '65, Jalan Pelangi 3', 'Skudai', 'Johor', 84600, 'Cancelled by Admin', 1);
...
(00005, 'rogesh', 'rogesh', 'rogesh@hotmail.com', 'user', '', '', 0, ''),
...
(00008, 'Chong Xin Yee', '789', 'xinyeeada@hotmail.com', 'admin', NULL, NULL, 0, '2dfd53f56fae8db5c1a16908e6b80398');
...
--
ALTER TABLE `category`
  MODIFY `category_id` int(4) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `food`
  MODIFY `food_id` int(4) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `real_cart`
--
ALTER TABLE `real_cart`
  MODIFY `real_cart_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;

--
-- AUTO_INCREMENT for table `trans`
--
ALTER TABLE `trans`
  MODIFY `transaction_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;

--
-- AUTO_INCREMENT for table `users`
--
ALTER TABLE `users`
  MODIFY `userid` int(5) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
COMMIT;
