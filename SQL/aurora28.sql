...
(37, 1, 11, 11, 1, 61, 1),
(38, 3, 12.5, 37.5, 2, 61, 1),
(39, 2, 9.4, 18.8, 3, 61, 1),
(40, 1, 10.2, 10.2, 4, 61, 1);
...
--
ALTER TABLE `cart`
  MODIFY `cart_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=110;
...
--
ALTER TABLE `real_cart`
  MODIFY `real_cart_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;

--
-- 使用表AUTO_INCREMENT `trans`
--
ALTER TABLE `trans`
  MODIFY `transaction_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=63;
