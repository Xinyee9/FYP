...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 18, 2022 at 09:30 PM
...
(00006, 'ng wee woen', '123', 'ngweewoen0415@gmail.com', 'user', '', '', 0, '4a405b34206fa317ac92c50563b3e135');
...
--
ALTER TABLE `cart`
  MODIFY `cart_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `users`
  MODIFY `userid` int(5) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
COMMIT;
