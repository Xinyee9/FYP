...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 05, 2022 at 04:40 PM
...
INSERT INTO `real_cart` (`real_cart_id`, `cart_qty`, `ori_price`, `subtotal`, `food_id`, `transaction_id`, `userid`) VALUES
(37, 1, 11, 11, 1, 63, 1),
(38, 3, 12.5, 37.5, 2, 63, 1),
(39, 2, 9.4, 18.8, 3, 63, 1),
(40, 1, 10.2, 10.2, 4, 63, 1),
(41, 1, 11, 11, 1, 63, 1);
...
(60, '2022-03-31', '06:48:49', '07:18:49', 'Jayson', '(M.C.Office A-01-01) B-11-07, Ixora Apartment', 'Bukit Beruang', 'Melaka', 75450, '', 1),
(61, '2022-03-31', '09:26:06', '09:56:06', 'Jayson', '(M.C.Office A-01-01) B-11-07, Ixora Apartment', 'Bukit Beruang', 'Melaka', 75450, 'Order Confirm', 1),
(62, '2022-03-31', '10:10:12', '10:40:12', 'Jayson', '(M.C.Office A-01-01) B-11-07, Ixora Apartment', 'Bukit Beruang', 'Melaka', 75450, '', 0),
(63, '2022-04-02', '03:01:35', '03:31:35', 'Chong', '12, Jln porah', 'New York', 'Malacca', 75450, 'Order Confirm', 1);
...
--
ALTER TABLE `cart`
  MODIFY `cart_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=112;
...
--
ALTER TABLE `real_cart`
  MODIFY `real_cart_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;

--
-- AUTO_INCREMENT for table `trans`
--
ALTER TABLE `trans`
  MODIFY `transaction_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;
