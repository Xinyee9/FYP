...
(00007, 'JJ', 'Jayson123', 'jaysonlimck@gmail.com', 'user', '', '', 0, '53fe92197f0a239d028f946729c72c4d');
...
--
ALTER TABLE `carttotal`
  MODIFY `total_id` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `trans`
  MODIFY `transaction_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
