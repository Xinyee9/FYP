...
<div class="header">
    <div id="title">
        ...
        <br /><br />
            <!-- Buttom to Add Admin -->
            <a href ="<?php echo SITEURL;?>adminpanel/add-food.php" class="btn-add">Add Food</a>
            <br /><br /><br />
                        ...
                        if($count>0)
                        {
                            ...
                            while($rows=mysqli_fetch_assoc($res))
                            {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo SITEURL;?>adminpanel/update-food.php?ID=<?php echo $ID; ?>" class="btn-update">Update Food</a>
                                        <a href="<?php echo SITEURL;?>adminpanel/delete-food.php?ID=<?php echo $ID; ?>&image_name=<?php echo $image_name;?>" class="btn-delete">Delete Food</a>
                                    </td>  
                                </tr>
