                        ...
                        if($count>0)
                        {
                            ...
                            while($rows=mysqli_fetch_assoc($res))
                            {
                                ...
                                <tr>
                                    ...
                                    <td >
                                        <a href="<?php echo SITEURL;?>adminpanel/change-password.php?ID=<?php echo $ID;?>" class="btn-add"> Change Password</a>
                                        <a href="<?php echo SITEURL;?>adminpanel/edit.php?ID=<?php echo $ID?>" class="btn-update">Update Admin</a>
                                        <a href="<?php echo SITEURL;?>adminpanel/delete.php?ID=<?php echo $ID; ?>&image_name=<?php echo $image_name;?>" class="btn-delete">Delete Admin</a>
                                    </td>  
                                </tr>
